...
const SocialClipboard = (props : {
    ...
    const clipboardText = () => {
        if (props.lang == "Português") {
            if (props.won) {
                return `🎉🥳 Eu venci o jogo do dia no Hackenbush jogando como ${props.color === "red" ? "🔴 Vermelho" : "🔵 Azul"}!\n\nJogue Hackenbush em: https://hackenbush.vercel.app/`;
            } else {
                return `😔 Eu perdi o jogo do dia no Hackenbush jogando como ${props.color === "red" ? "🔴 Vermelho" : "🔵 Azul"}, mas eu me diverti muito! 🤗\n\nJogue Hackenbush em: https://hackenbush.vercel.app/`
            }
        }
        else if (props.lang == "Français") {
            if (props.won) {
                return `🎉🥳 J'ai remporté le match du jour à Hackenbush en jouant comme ${props.color === "red" ? "🔴 Rouge" : "🔵 Bleu"}!\n\nJouez à Hackenbush sur: https://hackenbush.vercel.app/`;
            } else {
                return `😔 J'ai raté le match du jour à Hackenbush en jouant comme ${props.color === "red" ? "🔴 Rouge" : "🔵 Bleu"}, mais je me suis beaucoup amusé! 🤗\n\nJouez à Hackenbush sur: https://hackenbush.vercel.app/`
            }
        }
        else {
            if (props.won) {
                return `🎉🥳 I won today's Hackenbush game playing as ${props.color === "red" ? "🔴 Red" : "🔵 Blue"}!\n\nPlay Hackenbush at: https://hackenbush.vercel.app/`;
            } else {
                return `😔 I lost today's Hackenbush game playing as ${props.color === "red" ? "🔴 Red" : "🔵 Blue"}, but I had so much fun! 🤗\n\nPlay Hackenbush at: https://hackenbush.vercel.app/`
            }
        }
    }
